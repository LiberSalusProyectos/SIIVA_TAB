   ...
   ?>
    <script>
      jQuery(document).ready(function(e) {
        ...
        jQuery('#rotavirus1').click(function(e){
            if(jQuery(e.target).is('input')) return;
            jQuery('#rotavirus1').toggleClass('bg-gray')
            jQuery('#rotavirus1').toggleClass('bg-rotavirus')
            jQuery('#rotavirus1_').toggle()
            jQuery('input[name="rotavirus1"]').prop('checked', function(_, checked) {
                return !checked;
            })
        })
        ...
        jQuery('#rotavirus2').click(function(e){
            if(jQuery(e.target).is('input')) return;
            jQuery('#rotavirus2').toggleClass('bg-gray')
            jQuery('#rotavirus2').toggleClass('bg-rotavirus')
            jQuery('#rotavirus2_').toggle()
            jQuery('input[name="rotavirus2"]').prop('checked', function(_, checked) {
                return !checked;
            })
        })
        ...
        jQuery('#rotavirus3').click(function(e){
            if(jQuery(e.target).is('input')) return;
            jQuery('#rotavirus3').toggleClass('bg-gray')
            jQuery('#rotavirus3').toggleClass('bg-rotavirus')
            jQuery('#rotavirus3_').toggle()
            jQuery('input[name="rotavirus3"]').prop('checked', function(_, checked) {
                return !checked;
            })
        })
        ...
        <div class="offset-1 offset-lg-2 offset-md-1 offset-sm-1 col-10 col-sm-10 col-md-10 col-lg-8">
            <form method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-5 col-sm-5 border-headmid d-md-none"></div>
                    <div id="rotavirus1" class="col-7 col-sm-7 col-md-4 col-lg-5 p-2 border-mid <?php if($result[0]['rotavirus1']=='1') { echo 'bg-rotavirus'; } else { echo 'bg-gray';} ?>">
                        <span class="ml-4">ROTAVIRUS (Primera)</span>
                        <div id="rotavirus1_" <?php if($result[0]['rotavirus1']!='1') { echo 'style="display: none;"'; } ?> class="mt-2">
                            <input type="checkbox" <?php if($result[0]['rotavirus1']=='1') { echo 'checked="checked"'; } ?> style="display: none;" name="rotavirus1">
                            <input placeholder="Fecha de vacunación" name="rotavirus1_date" value="<?php echo $result[0]["rotavirus1_date"]; ?>" class="form-control custom-input date" autocomplete="off" />
                            <input type="text" class="form-control custom-input mt-1" name="rotavirus1_desc" value="<?php echo utf8_encode($result[0]["rotavirus1_desc"]); ?>" placeholder="Efectos adversos" autocomplete="off" />
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-5 col-sm-5 col-md-4 col-lg-2 border-headmid"></div>
                    <div id="rotavirus2" class="col-7 col-sm-7 col-md-8 col-lg-10 p-2 border-mid <?php if($result[0]['rotavirus2']=='1') { echo 'bg-rotavirus'; } else { echo 'bg-gray';} ?>">
                        <span class="ml-4">ROTAVIRUS (Segunda)</span>
                        <div class="row h-100 text-center">
                            <div id="rotavirus2_" <?php if($result[0]['rotavirus2']!='1') { echo 'style="display: none;"'; } ?> class="offset-md-3 col-md-6 mt-2">
                                <input type="checkbox" <?php if($result[0]['rotavirus2']=='1') { echo 'checked="checked"'; } ?> style="display: none;" name="rotavirus2">
                                <input placeholder="Fecha de vacunación" name="rotavirus2_date" value="<?php echo $result[0]["rotavirus2_date"]; ?>" class="form-control custom-input date" autocomplete="off" />
                                <input type="text" class="form-control custom-input mt-1" name="rotavirus2_desc" value="<?php echo utf8_encode($result[0]["rotavirus2_desc"]); ?>" placeholder="Efectos adversos" autocomplete="off" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-5 col-sm-5 border-headmid d-md-none"></div>
                    <div id="rotavirus3" class="col-7 col-sm-7 col-md-4 col-lg-5 p-2 border-mid <?php if($result[0]['rotavirus3']=='1') { echo 'bg-rotavirus'; } else { echo 'bg-gray';} ?>">
                        <span class="ml-4">ROTAVIRUS (Tercera)</span>
                        <div id="rotavirus3_" <?php if($result[0]['rotavirus3']!='1') { echo 'style="display: none;"'; } ?> class="mt-2">
                            <input type="checkbox" <?php if($result[0]['rotavirus3']=='1') { echo 'checked="checked"'; } ?> style="display: none;" name="rotavirus3">
                            <input placeholder="Fecha de vacunación" name="rotavirus3_date" value="<?php echo $result[0]["rotavirus3_date"]; ?>" class="form-control custom-input date" autocomplete="off" />
                            <input type="text" class="form-control custom-input mt-1" name="rotavirus3_desc" value="<?php echo utf8_encode($result[0]["rotavirus3_desc"]); ?>" placeholder="Efectos adversos" autocomplete="off" />
                        </div>
                    </div>
                </div>
