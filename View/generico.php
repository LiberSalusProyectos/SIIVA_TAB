    ...
    <div class="row">
      <div class="offset-sm-0 offset-md-1 col-sm-12 col-md-10">
        ...
        <table>
          <thead>
            <tr>
              <th style="color:white;background-color:rgb(247, 164, 26);">Rango de edad</th>
              <th style="color:white;background-color:rgb(247, 164, 26);">Mujeres</th>
              <th style="color:white;background-color:rgb(247, 164, 26);">Hombres</th>
              <th style="color:white;background-color:rgb(247, 164, 26);">Sin género/No válido</th>
              <th style="color:white;background-color:rgb(247, 164, 26);">Total</th>
            </tr>
          </thead>
          <tbody>
            <?php $fem=0; $masc=0; $gi=0; $total=0; foreach ($result as $key=>$row): $fem+=$row["feminine"]; $masc+=$row["masculine"];; $gi+=$row["gender_inv"];; $total+=$row["total"]; ?>
              <tr>
                <td style="text-align:left;"><?php echo utf8_encode($row["age"]); ?></td>
