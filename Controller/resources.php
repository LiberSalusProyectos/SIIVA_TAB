...
function saveGynecologyData($connection, $method, $data, $id_user){
	...
	$result = saveGynecologyData_DOM($connection, $method,
		$data['id_patient'],
		($data['ferrous_fumarate_a']!="" ? '1' : 'NULL'),
		($data['ferrous_fumarate_b']!="" ? '1' : 'NULL'),
		($data['ferrous_fumarate_c']!="" ? '1' : 'NULL'),
		($data['ferrous_fumarate_d']!="" ? '1' : 'NULL'),
		($data['folic_acid_a']!="" ? '1' : 'NULL'),
		($data['folic_acid_b']!="" ? '1' : 'NULL'),
		($data['folic_acid_c']!="" ? '1' : 'NULL'),
		($data['folic_acid_d']!="" ? '1' : 'NULL'),
		($data['multivitamins_a']!="" ? '1' : 'NULL'),
		($data['multivitamins_b']!="" ? '1' : 'NULL'),
		($data['multivitamins_c']!="" ? '1' : 'NULL'),
		($data['multivitamins_d']!="" ? '1' : 'NULL'),
		($data['hiv_test_a']!="" ? '1' : 'NULL'),
		($data['hiv_test_b']!="" ? '1' : 'NULL'),
		($data['hiv_test_c']!="" ? '1' : 'NULL'),
		($data['hiv_test_d']!="" ? '1' : 'NULL'),
		($data['syphilis_test_a']!="" ? '1' : 'NULL'),
		($data['syphilis_test_b']!="" ? '1' : 'NULL'),
		($data['syphilis_test_c']!="" ? '1' : 'NULL'),
		($data['syphilis_test_d']!="" ? '1' : 'NULL'),
		($data['newborn_care_a']!="" ? '1' : 'NULL'),
		($data['newborn_care_b']!="" ? '1' : 'NULL'),
		($data['newborn_care_c']!="" ? '1' : 'NULL'),
		($data['newborn_care_d']!="" ? '1' : 'NULL'),
		($data['breast_feed_a']!="" ? '1' : 'NULL'),
		($data['breast_feed_b']!="" ? '1' : 'NULL'),
		($data['breast_feed_c']!="" ? '1' : 'NULL'),
		($data['breast_feed_d']!="" ? '1' : 'NULL'),
