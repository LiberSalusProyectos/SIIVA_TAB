...
function saveFamilyRecordData($connection, $method, $data, $id_user){
	...
	$result = saveFamilyRecordData_DOM($connection, $method,
		...
		($data['hypertension']!="" ? $data['hypertension'] : 'NULL'),
		($data['diabetes']!="" ? $data['diabetes'] : 'NULL'),
		($data['heart_attack']!="" ? $data['heart_attack'] : 'NULL'),
		($data['cardiac_arrhythmia']!="" ? $data['cardiac_arrhythmia'] : 'NULL'),
		($data['heart_failure']!="" ? $data['heart_failure'] : 'NULL'),
		($data['heart_other']!="" ? $data['heart_other'] : 'NULL'),
		($data['heart_other_desc']!="" ? "'".utf8_decode($data['heart_other_desc'])."'" : 'NULL'),
		($data['asthma']!="" ? $data['asthma'] : 'NULL'),
		($data['obesity']!="" ? $data['obesity'] : 'NULL'),
		($data['dyslipidemia']!="" ? "'".$data['dyslipidemia']."'" : 'NULL'),
		($data['breast_cancer']!="" ? $data['breast_cancer'] : 'NULL'),
		($data['cervical_cancer']!="" ? $data['cervical_cancer'] : 'NULL'),
		($data['prostate_cancer']!="" ? $data['prostate_cancer'] : 'NULL'),
		($data['leukemia']!="" ? $data['leukemia'] : 'NULL'),
		($data['cancer_other']!="" ? $data['cancer_other'] : 'NULL'),
		($data['cancer_other_desc']!="" ? "'".utf8_decode($data['cancer_other_desc'])."'" : 'NULL'),
		($data['anxiety_depression']!="" ? $data['anxiety_depression'] : 'NULL'),
		($data['eating_disorders']!="" ? $data['eating_disorders'] : 'NULL'),
		($data['schizophrenia']!="" ? $data['schizophrenia'] : 'NULL'),
		($data['psychiatric_other']!="" ? $data['psychiatric_other'] : 'NULL'),
		($data['psychiatric_other_desc']!="" ? "'".utf8_decode($data['psychiatric_other_desc'])."'" : 'NULL'),
		($data['glaucoma']!="" ? $data['glaucoma'] : 'NULL'),
		($data['ametropia']!="" ? $data['ametropia'] : 'NULL'),
		($data['waterfalls']!="" ? $data['waterfalls'] : 'NULL'),
		($data['eye_other']!="" ? $data['eye_other'] : 'NULL'),
		($data['eye_other_desc']!="" ? "'".utf8_decode($data['eye_other_desc'])."'" : 'NULL'),
		($data['hyperthyroidism']!="" ? $data['hyperthyroidism'] : 'NULL'),
		($data['hypothyroidism']!="" ? $data['hypothyroidism'] : 'NULL'),
		($data['cushing']!="" ? $data['cushing'] : 'NULL'),
		($data['endocrine_other']!="" ? $data['endocrine_other'] : 'NULL'),
		($data['endocrine_other_desc']!="" ? "'".utf8_decode($data['endocrine_other_desc'])."'" : 'NULL'),
		($data['preeclampsia']!="" ? $data['preeclampsia'] : 'NULL'),
		($data['cystic_ovary']!="" ? $data['cystic_ovary'] : 'NULL'),
		($data['gestational_diabetes']!="" ? $data['gestational_diabetes'] : 'NULL'),
		($data['gynecological_other']!="" ? $data['gynecological_other'] : 'NULL'),
		($data['gynecological_other_desc']!="" ? "'".utf8_decode($data['gynecological_other_desc'])."'" : 'NULL'),
		($data['parkinson']!="" ? $data['parkinson'] : 'NULL'),
		($data['epilepsy']!="" ? $data['epilepsy'] : 'NULL'),
		($data['alzheimer']!="" ? $data['alzheimer'] : 'NULL'),
		($data['neurological_other']!="" ? $data['neurological_other'] : 'NULL'),
		($data['neurological_other_desc']!="" ? "'".utf8_decode($data['neurological_other_desc'])."'" : 'NULL'),
		($data['tuberculosis']!="" ? $data['tuberculosis'] : 'NULL'),
		($data['sida']!="" ? $data['sida'] : 'NULL'),
		($data['syphilis']!="" ? $data['syphilis'] : 'NULL'),
		($data['infectious_other']!="" ? $data['infectious_other'] : 'NULL'),
		($data['infectious_other_desc']!="" ? "'".utf8_decode($data['infectious_other_desc'])."'" : 'NULL'),
		($data['down_syndrome']!="" ? $data['down_syndrome'] : 'NULL'),
		($data['cretinism_acromegaly']!="" ? $data['cretinism_acromegaly'] : 'NULL'),
		($data['hemophilia']!="" ? $data['hemophilia'] : 'NULL'),
		($data['genetic_other']!="" ? $data['genetic_other'] : 'NULL'),
