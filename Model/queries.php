...
function saveEnvironmentData_DOM($connection, $method,
	...
	`pollution_react`				= '$pollution_react',
...
function saveChildVaccinatonData_DOM($connection, $method,
	...
	`rotavirus1_date` 		= ".($rotavirus1_date !== '' ? "'$rotavirus1_date'" : "NULL").",
	`rotavirus1_desc` 		= '$rotavirus1_desc',
	...
	`rotavirus2_date` 		= ".($rotavirus2_date !== '' ? "'$rotavirus2_date'" : "NULL").",
	`rotavirus2_desc` 		= '$rotavirus2_desc',
	...
	`influenza1_date` 		= ".($influenza1_date !== '' ? "'$influenza1_date'" : "NULL").",
	`influenza1_desc` 		= '$influenza1_desc',
	`rotavirus3` 			= '$rotavirus3',
	`rotavirus3_date` 		= ".($rotavirus3_date !== '' ? "'$rotavirus3_date'" : "NULL").",
	`rotavirus3_desc` 		= '$rotavirus3_desc',
 ...
 * @return [bool]							[Estado de la consulta]
 */
function saveLoadData_DOM($connection, $id_form, $id_data, $is_match, $invoice, $affiliation_number, 
	$name, $first_lastname, $second_lastname, $relationship, $occupation, $age, $birthdate, $gender ){
